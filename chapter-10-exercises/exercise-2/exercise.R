...
print(nrow(salaries[salaries$adjustments > 0, ]))
...
print(mean(salaries[salaries$adjustments <= 0, "adjustments"]))

## Consider: do the above averages match what you expected them to be based on 
## how you generated the salaries?

# Yes, the first average salary change (+2557.17) is about halfway between the salary 
# changes -5000 and +10000, which is the range we specified for the randomly generated
# adjustments. The second average salary change, of only the people who did not receive
# a raise (adjustments <= 0) was -2010.689, which is around halfway between the negative
# adjustments allowed in our specified adjustment range (between -5000 and 0).
