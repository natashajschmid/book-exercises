...
#   The organization has 20 public repositories.

# Now a second query:
# Create a variable `search_endpoint` that stores the endpoint used to search 
# for repositories. (Hint: look for a "Search" endpoint in the documentation).
# search_endpoint <- paste0("q", query = query_params)
...
response2 <- GET(paste0("https://api.github.com", search_endpoint), query = query_params)
